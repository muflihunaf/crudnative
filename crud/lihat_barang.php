...
<body>
    ...
    <table class="table table-bordered">
        <thead>
            <tr>
                <th>No</th>
                <th><a href="lihat_barang.php?nama_barang">Nama Barang</a></th>
                <th><a href="lihat_barang.php?jenis_barang">Jenis Barang</a></th>
                <th><a href="lihat_barang.php?kondisi">Kondisi</a></th>
        ...
        <tbody>
            <?php 
                ...
                if (isset($_GET['nama_barang'])) {
                    $query = mysqli_query($host, "SELECT * FROM tbl_barang ORDER BY nama_barang ASC");
                }elseif (isset($_GET['jenis_barang'])) {
                    $query = mysqli_query($host, "SELECT * FROM tbl_barang ORDER BY jenis_barang ASC");
                }elseif (isset($_GET['kondisi'])) {
                    $query = mysqli_query($host, "SELECT * FROM tbl_barang ORDER BY status ASC");
                }else{
                    $query = mysqli_query($host, "SELECT * FROM tbl_barang ORDER BY id_barang DESC");
                }
            ...
            <tr>
                ...
                <td><?= $list['status'] ?></td>
                <td> <a class="btn btn-info" href="edit.php?id_barang=<?=$list['id_barang']?>">Edit</a> </td>
                <td> <a class="btn btn-danger" href="hapus.php?id_barang=<?=$list['id_barang']?>">Hapus</a> </td>
            </tr>
            <?php 
                }
                ?>
